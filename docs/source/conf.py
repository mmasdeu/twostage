...
project = u"Algorithms for proving that class-number-one real quadratic fields are 2-stage euclidean, and to find continued fraction expansions in them"
copyright = u'2017, Marc Masdeu'
package_name = 'twostage'
package_folder = "../../twostage"
authors = u"Xavier Guitart, Marc Masdeu"
